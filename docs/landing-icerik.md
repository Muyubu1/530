...
- [S1_L2]    2. satır       → Önün uçurum, ardın boşluk.

### Kare 2 — (görsel 3)
- [S2_HUD]   HUD kelimesi   → SABIR
- [S2_STAIR] Arka dev kelime → SABIR
- [S2_L1]    1. satır       → İlk adım en ağırıdır.
- [S2_L2]    2. satır       → Çünkü onu tek başına atarsın.

### Kare 3 — (görsel 4)
- [S3_HUD]   HUD kelimesi   → AZİM
- [S3_STAIR1] Arka dev kelime (üst) → DİSİPLİN
- [S3_STAIR2] Arka dev kelime (alt) → AZİM
- [S3_L1]    1. satır       → Sonra bir gün, "yeter" dersin.
...
- [S4_L1]    1. satır       → Her basamak seni değiştirir.
- [S4_L2]    2. satır       → Çıkan adam, başlayan adam değildir.

### Kare 5 — (görsel 6)
- [S5_HUD]   HUD kelimesi   → VARIŞ
- [S5_L1]    1. satır       → Ve bir gün, zirveye varırsın.
- [S5_L2]    2. satır       → Artık o adam değilsin.

### Kare 6 — (görsel 7)
- [S6_HUD]   HUD kelimesi   → KARDEŞLİK
- [S6_L1]    1. satır       → Ama orada yalnız değilsin.
- [S6_L2]    2. satır       → Senin gibi uyanan, sözünü tutan kardeşlerin var.
...
- [B8_C2_D] Kart 2 açıklama → Kendinden büyük bir şeye bağlan.
...
- [B8_GET_2] Madde 2 → Kardeşlik topluluğu
- [B8_GET_3] Madde 3 → Hesap verme sistemi
...
- [B9_FOR_3] Madde 3 → Dibe vurmuş ama bırakmamış olanlar.
...
- [B9_NOT_3] Madde 3 → Kalabalıkta kaybolmak isteyenler.
...
- [B10_SUB]     Alt cümle  → Kalabalığa değil — kendine hesap veren bir hayata.
...
- [B11_DONE_TXT]  Mesaj (alt satır için <br>) → Başvurun alındı.<br>Kardeşliğe bir adım daha yakınsın.
...
- [TOAST_ERR]  Form uyarısı (hata) → Bir şeyler ters gitti. Lütfen tekrar dene.
